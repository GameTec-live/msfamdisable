...
try:
    ...
    ctypes.windll.user32.MessageBoxW(0, "No data.dll!", "Error!", 1)
    time.sleep(2)
    libary.debugconsole()
...
if data == 1:
    ...
    ctypes.windll.user32.MessageBoxW(0, "Error reading data.dll file", "Error!", 1)
            ...
            if event.type == pygame.USEREVENT:
                if event.user_type == pygame_gui.UI_BUTTON_PRESSED:
                    if event.ui_element == button_help:
                        print('Starting Help')
                        ctypes.windll.user32.MessageBoxW(0, "MS-famdisable is a tool, trough witch you can control, wich part of the MS Family Control system is active.", "Help", 1)
